        ...
        <header class="main-header">
            ...
            <a href="home.php" class="logo">
                ...
                <span class="logo-mini">
                   <img src="dist/img/favicon.png" height="25px" width="25px" style="border-radius:15px;" alt="">
                </span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg">
                <img src="dist/img/favicon.png" height="30px" width="40px" style="border-radius:15px;" alt="">
                </span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="dist/img/favicon.png" class="user-image" alt="User Image">
                                    <span class="hidden-xs">Admin</span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="dist/img/favicon.png" class="img-circle" alt="User Image">
                                        <p>
                                            Admin
