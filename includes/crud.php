...
define('DOMAIN_URL', 'https://gmw.graymatterworks.com/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "u743445510_gmw";  // Change as required
    private $db_pass = "Greymatter@2023";  // Change as required
    private $db_name = "u743445510_gmw";    // Change as required
