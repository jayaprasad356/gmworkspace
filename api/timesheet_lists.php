...
$sql = "SELECT *,timesheets.id AS id FROM timesheets,projects WHERE timesheets.project_id = projects.id AND timesheets.staff_id = $staff_id ORDER BY date LIMIT 20";
$db->sql($sql);
$res = $db->getResult();
$num = $db->numRows($res);
if ($num >= 1) {
